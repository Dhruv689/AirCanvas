...
# The advantage of the HSV model over the RGB or BGR model is that it separates luma(image intensity), from chroma(color information).
...
kernel = np.ones((5,5),np.uint8)   # remove noise 
